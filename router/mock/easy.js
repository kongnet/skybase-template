...
module.exports = {
  ...
  async getBing(ctx){
    let r = await req('https://cn.bing.com/HPImageArchive.aspx?format=js&idx=0&n=1', true) 
    ctx.type='html'
